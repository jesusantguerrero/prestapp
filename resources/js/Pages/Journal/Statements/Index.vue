<template>
  <AppLayout title="Reportes">
    <template #header>
      ...
      >
        ...
        >
          ...
          <AppButton
            variant="inverse"
            @click="$inertia.visit('/statements/expense')"
            class="text-center w-28"
          >
            Egresos
          </AppButton>
    ...
    <div class="w-full py-10 mx-auto mt-8 sm:px-6 lg:px-8 print:w-[210mm] print">
      ...
      >
        <div class="mt-10 divide-y items print:w-[210mm] print">
          <div
          ...
          >
            <div class="w-full">
              <h4 class="text-xl font-bold">{{ category.label }}</h4>
            ...
            <div class="w-full space-y-2">
              ...
              >
                <h5 class="text-lg font-bold text-blue-500">
                  {{ report.label }}
                </h5>
