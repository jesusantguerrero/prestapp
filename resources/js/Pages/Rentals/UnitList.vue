...
import SiteLayout from "@/Components/templates/SiteLayout.vue";
...
<template>
  <SiteLayout title="Unidades">
    <template #header>
      <section class="grid grid-cols-2 md:flex md:space-x-4 gap-4 md:gap-0 w-full">
        <AppSearch
    ...
    <main class="py-16 max-w-7xl mx-auto ">
      <AtTable
