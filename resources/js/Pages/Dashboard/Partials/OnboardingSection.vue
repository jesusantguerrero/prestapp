...
<template>
  <main>
    ...
    <section class="mb-8 flex items-center justify-between space-x-4">
      ...
      <section
        class="flex bg-base-lvl-3 px-4 py-4 rounded-md shadow-md overflow-auto items-center w-full space-x-12"
      >
