        ...
        <div class="text-left section_container">
            <div v-for="section in tabs[currentTab].sections" :key="section" class="">
              <template v-if="section && section.length">
                  <Link :href="section[1]" class="flex justify-between w-full px-2 py-2 font-bold text-gray-400 transition transform bg-white border hover:text-blue-400 hover:shadow-md hover:border-blue-400">
                      <div>
                          {{ section[0] }}
                      </div>
